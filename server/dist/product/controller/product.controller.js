...
let ProductController = class ProductController {
    ...
    async uploadProductAI(currentUser, files, productInfo) {
        console.log('controller upload - ai');
        return await this.productService.uploadProductAI(currentUser, files, JSON.parse(productInfo.data));
    }
};
__decorate([
